...
<head>
    ...
    <title>Control Enfermeria Reyes</title><!--begin::Primary Meta Tags-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    ...
    <img src="<?php echo isset($_SESSION['foto']) ? $_SESSION['foto'] : '../../dist/assets/img/default-image.jpg'; ?>" 
    ...
    <span class="d-none d-md-inline">
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" data-accordion="false">
                        <br>
                        <li class="nav-item"> <a href="./index.html" class="nav-link active"> <i class="bi bi-hospital"></i></i>
                                <p>
                                    INICIO
                                </p>
                            </a>
                            <br>
                        <!-- Aqui ver lo que me sirva -->
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="bi bi-person-square"></i>
                            <p>
                                Estudiantes
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="bi bi-box-seam-fill"></i>
                                <p>
                                    Insumos Ancianato
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                        ...
                        <br><br><br><br><br>
                        <li class="nav-item">
                            <a href="../../../controller/controlador_cerrar_sesion.php" class="nav-link">
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline"><a href="https://www.reyespatria.edu.co/">Colegio Cooperativo Reyes Patria</a></div> <!--end::To the end--> <!--begin::Copyright--> <strong>
                Aprendiz Brayan Torres, ADSO 2615133.            
            </strong>
            <!--end::Copyright-->
        </footer> <!--end::Footer-->
